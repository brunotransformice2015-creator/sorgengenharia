      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <a
              href="#contato"
              className="inline-block mt-10 bg-primary text-primary-foreground font-semibold px-8 py-4 rounded-lg hover:opacity-90 transition-opacity text-sm"
            >
            ...
            <div className="bg-primary rounded-2xl p-10 md:p-14">
              <div className="text-center">
                ...
                <p className="text-primary-foreground/80 text-sm leading-relaxed max-w-sm mx-auto">
                  Trabalhamos com as principais instituições financeiras do
                  Brasil para garantir as melhores condições de crédito para a
                  sua obra.
                </p>
              </div>
            </div>
